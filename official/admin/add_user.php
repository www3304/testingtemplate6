                    ...
                    $stmt = $official_admin_connection->prepare($insert_query);
                     if ($stmt === false) {
                        ...
                        if ($stmt->execute()) {
                            ...
                            $error_message = 'Error adding user to database: ' . $stmt->error;
                        }
                        $stmt->close();
                    }
                }
...
<body class="bg-gray-50 text-gray-900 min-h-screen flex flex-col">
                        ...
                        <form action="add_user.php" method="POST">
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1.5 text-xs text-gray-500">Enter a strong password for the user.</p>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const passwordField = document.getElementById('password'); // Changed ID
